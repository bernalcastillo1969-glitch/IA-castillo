...
class GeminiProvider(AIProvider):
    ...
    def get_response(self, prompt: str, system_instruction: str, history: List[Dict[str, Any]], multimodal_parts: List[Dict[str, Any]] = None) -> str:
        ...
        try:
            ...
            return f"⚠️ Problema técnico en Gemini: {str(e)}. Pero no te preocupes, ¡vuelve a escribirme pronto!"
    ...
    def get_response(self, prompt: str, system_instruction: str, history: List[Dict[str, Any]], multimodal_parts: List[Dict[str, Any]] = None) -> str:
        ...
        try:
            ...
            if "429" in err_str or "rate_limit" in err_str:
                return MSG_RECARGA_ENERGIA
            return f"⚠️ Problema técnico en Groq: {str(e)}. ¡Reintenta en un momento!"
